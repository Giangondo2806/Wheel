import { WinWheelDefautOption, OndoWheelOption } from './options/winwheel.option';
...
export class OndoWheel {
    ...
    deleteSegment = function (position) {
    ...
    getSegmentNumberAt = function (x, y) {
    ...
    getIndicatedSegmentNumber = function () {
    ...
    getRotationPosition = function () {
        ...
        if (rawAngle >= 0) {
            ...
            if (rawAngle < -360) {
                const timesPast360 = Math.ceil(rawAngle / 360);   // Ceil when negative.
